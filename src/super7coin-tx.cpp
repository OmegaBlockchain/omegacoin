...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Super7Coin Core super7coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  super7coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded super7coin transaction") + "\n" +
              "  super7coin-tx [options] -create [commands]   " + _("Create hex-encoded super7coin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded super7coin transaction
