...
static int AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Super7Coin Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  super7coin-cli [options] <command> [params]  " + _("Send command to Super7Coin Core") + "\n" +
                  "  super7coin-cli [options] help                " + _("List commands") + "\n" +
                  "  super7coin-cli [options] help <command>      " + _("Get help for a command") + "\n";
