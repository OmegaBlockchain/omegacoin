...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("01.dnsseed.omegablockchain.net", "01.dnsseed.omegablockchain.net"));
        vSeeds.push_back(CDNSSeedData("02.dnsseed.omegablockchain.net", "02.dnsseed.omegablockchain.net"));
        vSeeds.push_back(CDNSSeedData("03.dnsseed.omegablockchain.net", "03.dnsseed.omegablockchain.net")); 
