...
This mechanism has been integrated into Bitcore-Node-OmegaCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/omegacoinpay/insight-api-omegacoin#web-socket-api](https://github.com/omegacoinpay/insight-api-omegacoin#web-socket-api)
* API: [https://github.com/omegacoinpay/insight-api-omegacoin#instantsend-transactions](https://github.com/omegacoinpay/insight-api-omegacoin#instantsend-transactions)
...
By default, the OmegaCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the OmegaCoin Core daemon:
