...
Only requiring some minor changes is super7coin.cpp.
...
Changes to super7coin.cpp
----------------------
super7coin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
