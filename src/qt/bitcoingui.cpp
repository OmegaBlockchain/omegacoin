    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("OmegaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OmegaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and omegacoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About OmegaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OmegaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OmegaCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OmegaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OmegaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a omegacoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OmegaCoin Core help message to get a list with possible OmegaCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("OmegaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OmegaCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("OmegaCoin Core"); // default title
    ...
    // Append title to "OmegaCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
