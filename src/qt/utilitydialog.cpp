    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("OmegaCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About OmegaCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  omegacoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the OmegaCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OMEGA, 0.1 OMEGA, 1 OMEGA and 10 OMEGA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://omegacoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://omegacoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("OmegaCoin Core is shutting down...") + "<br /><br />" +
