...
2. run omegacoind with -printalert or -sendalert like this:
   /path/to/omegacoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.omegacoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/OmegaCoin Core:0.12.0.58/"));
