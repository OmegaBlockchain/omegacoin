...
OmegaCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as OmegaCoin Core, where everyone uses
...
pay attention to for reviewers of OmegaCoin Core code.

General OmegaCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: OmegaCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
