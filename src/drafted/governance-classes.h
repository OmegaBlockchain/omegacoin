 ...
 *
 *   // network
 *   CSuper7CoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.super7coin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSuper7CoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSuper7CoinNetwork(UniValue objIn)
    {
...
// // can be under: Super7CoinNetwork
// //   -- signature requirements : Key1(User)
// class CSuper7CoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == Super7CoinNetwork);
//     // }
