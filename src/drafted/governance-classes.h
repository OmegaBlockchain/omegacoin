 ...
 *
 *   // network
 *   COmegaCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.omegacoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class COmegaCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    COmegaCoinNetwork(UniValue objIn)
    {
...
// // can be under: OmegaCoinNetwork
// //   -- signature requirements : Key1(User)
// class COmegaCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == OmegaCoinNetwork);
//     // }
