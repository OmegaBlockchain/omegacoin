...
#define BOOST_TEST_MODULE OmegaCoin Test Suite

#include "test_omegacoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_omegacoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
