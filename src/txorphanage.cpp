...
bool TxOrphanage::AddTx(const CTransactionRef& tx, NodeId peer)
{
    ...
    // Ignore big transactions to avoid send-big-orphans memory exhaustion
    // (CVE-2012-3789). A legitimate large orphan will be rebroadcast after
    // its parents are mined.
...
void TxOrphanage::SetCandidatesByBlock(const CBlock& block)
{
    ...
    // Block-sourced candidates have no peer attribution; use NodeId -1 as sentinel.
    // Flush the previous block's set before populating.
