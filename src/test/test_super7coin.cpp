...
#define BOOST_TEST_MODULE Super7Coin Test Suite

#include "test_super7coin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_super7coin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
