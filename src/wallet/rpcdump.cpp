...
UniValue dumpwallet(const JSONRPCRequest& request)
{
    RPCHelpMan{"dumpwallet",
        ...
        {
            {"filename", RPCArg::Type::STR, RPCArg::Optional::NO, "The filename with path (either absolute or relative to omegad)"},
        },
        RPCResult{
                RPCResult::Type::OBJ, "", "",
                {
    ...
    UniValue obj(UniValue::VOBJ);
    obj.pushKV("omegacoreversion", CLIENT_BUILD);
                    ...
                    result.pushKV(
                        ...
                        JSONRPCError(
                            ...
                            strprintf("Rescan failed for key with creation timestamp %d. There was an error reading a "
                                      ...
                                      "caused by pruning or data corruption (see omegad log for details) and could "
