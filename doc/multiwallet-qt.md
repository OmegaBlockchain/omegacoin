...
Only requiring some minor changes is omegacoin.cpp.
...
Changes to omegacoin.cpp
----------------------
omegacoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
