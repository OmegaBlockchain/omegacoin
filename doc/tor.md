...
The first step is running OmegaCoin Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./omegacoind -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./omegacoind -proxy=127.0.0.1:9050


2. Run a OmegaCoin Core hidden server
-------------------------------
...
config file):
	...
	HiddenServiceDir /var/lib/tor/omegacoincore-service/
	HiddenServicePort 7777 127.0.0.1:7777
	HiddenServicePort 17777 127.0.0.1:17777

The directory can be different of course, but (both) port numbers should be equal to
your omegacoind's P2P listen port (7777 by default).

	-externalip=X   You can tell OmegaCoin Core about its publicly reachable address using
	                this option, and this can be a .onion address. Given the above
	                configuration, you can find your onion address in
	                /var/lib/tor/omegacoincore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./omegacoind -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./omegacoind ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./omegacoind -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known OmegaCoin Core Tor relays
------------------------------------
...
OmegaCoin Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if OmegaCoin Core is listening, and
