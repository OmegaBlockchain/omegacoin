...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OmegaCoinNetwork") type = OmegaCoinNetwork;
    if(strType == "OmegaCoinNetworkVariable") type = OmegaCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OmegaCoinNetwork) s = "OmegaCoinNetwork";
    if(type == OmegaCoinNetworkVariable) s = "OmegaCoinNetworkVariable";
