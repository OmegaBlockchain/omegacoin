    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Super7Coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Super7Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and super7coin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Super7Coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Super7Coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Super7Coin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Super7Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Super7Coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a super7coin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Super7Coin Core help message to get a list with possible Super7Coin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Super7Coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Super7Coin network", "", count));
    } else {
...
{
    QString strTitle = tr("Super7Coin Core"); // default title
    ...
    // Append title to "Super7Coin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
