...
{
    const char* pszTimestamp = "Omega Network has succesfully launched on 02 01 2018!";
...
public:
    CMainParams() {
        ...
        consensus.nBudgetPaymentsCycleBlocks = 35000; // ~30 days at 74.1s avg block time (measured block 2,000,000–3,149,180)
        consensus.nBudgetPaymentsWindowBlocks = 100;
        consensus.nSuperblockStartBlock = 614820; // The block at which 12.1 goes live (end of final 12.0 budget cycle)
        consensus.nSuperblockStartHash = uint256S("000000000037e935c414053148efaf0382a289881f8d31cdeccbbab70dfb5a0e");
        consensus.nSuperblockCycle = 35000; // ~30 days at 74.1s avg block time (measured block 2,000,000–3,149,180)
        ...
        consensus.nHPMasternodeHeight = 3200000;
        // One-time phantom-masternode purge. PROVISIONAL height — must be set with
        ...
        consensus.nPowTargetSpacing = 60; // Omega: 60 seconds
        ...
        vSeeds.emplace_back("seed.omegablockchain.net");

        // Omega addresses start with 'o'
        ...
        vSporkAddresses = {"oLDnqdsFSFRZCjcBKsz8xeoYCn7SiateZd"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        consensus.BRRHeight = std::numeric_limits<int>::max();
        consensus.nSchnorrHeight = 100;
        consensus.nLargeElementsHeight = 100;
        consensus.nSmsgRoomHeight = 100;
        ...
        // All BIP9 deployments start at time 0 (immediately active)
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        ...
        genesis = CreateGenesisBlock(1741478400, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x595b906033b18c10331177a3044d8a6063a3388ee8a09d779d003946f008d64c"));
        assert(genesis.hashMerkleRoot == uint256S("0xf1c12dcba82d19825180cba39bcc19781d3474c486073977a8dbbcc35901c042"));
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        consensus.nSchnorrHeight = 1;
        consensus.nLargeElementsHeight = 1;
        consensus.nSmsgRoomHeight = 1;
