...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "Super7CoinNetwork") type = Super7CoinNetwork;
    if(strType == "Super7CoinNetworkVariable") type = Super7CoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == Super7CoinNetwork) s = "Super7CoinNetwork";
    if(type == Super7CoinNetworkVariable) s = "Super7CoinNetworkVariable";
