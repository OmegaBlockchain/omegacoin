...
This mechanism has been integrated into Bitcore-Node-Super7Coin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/super7coinpay/insight-api-super7coin#web-socket-api](https://github.com/super7coinpay/insight-api-super7coin#web-socket-api)
* API: [https://github.com/super7coinpay/insight-api-super7coin#instantsend-transactions](https://github.com/super7coinpay/insight-api-super7coin#instantsend-transactions)
...
By default, the Super7Coin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Super7Coin Core daemon:
