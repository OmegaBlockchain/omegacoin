    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  omega-qt [command-line options]                     \n";
...
All the Omega in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
